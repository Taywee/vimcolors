...
hi NonText ctermfg=245 ctermbg=NONE cterm=NONE guifg=#87FF5F guibg=NONE gui=NONE
...
hi Visual ctermfg=250 ctermbg=97 cterm=bold guifg=#87FF5F guibg=#875FAF gui=bold
...
hi CursorLineNr ctermfg=113 ctermbg=233 cterm=bold guifg=#878787 guibg=#121212 gui=bold
hi CursorColumn ctermfg=NONE ctermbg=235 cterm=NONE guifg=NONE guibg=#262626 gui=NONE
hi Search		ctermfg=252		ctermbg=241		cterm=none		guifg=#d787ff	guibg=#636066	gui=none
...
hi ModeMsg ctermfg=250 ctermbg=NONE cterm=bold guifg=#87FF5F guibg=NONE gui=bold
hi MoreMsg ctermfg=250 ctermbg=NONE cterm=bold guifg=#87FF5F guibg=NONE gui=bold
hi Question ctermfg=250 ctermbg=NONE cterm=underline guifg=#87FF5F guibg=NONE gui=underline
...
hi Pmenu ctermfg=113 ctermbg=16 cterm=NONE guifg=#87FF5F guibg=#000000 gui=NONE
...
"}}}
" Syntax highlighting"{{{
hi Comment ctermfg=247 ctermbg=NONE cterm=NONE guifg=#878787 guibg=NONE gui=italic
hi Constant ctermfg=156 ctermbg=NONE cterm=NONE guifg=#AFFF87 guibg=NONE gui=NONE
hi String ctermfg=113 ctermbg=NONE cterm=NONE guifg=#AFD7AF guibg=NONE gui=NONE
